        ...
        <div className="p-5">
          ...
          <div className="flex flex-col items-center">
            ...
            <a
              ...
              target="_blank"
              className=" bg-gray-800 text-white rounded-lg inline-flex items-center 
      ...
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow relative h-[500px]">
        ...
        <div className="p-5">
          ...
          <div className="flex flex-col items-center">
            <button
              type="button"
              class="text-white bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center"
            >
              <svg
